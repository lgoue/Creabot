...
class AgentDa():
    ...
    def possible_idea_quality(self):
        ...
        def update_state(self, user_da):
            ...
            match self.bin:
                ...
                case DialogActAgent.PROBLEM_STATEMENT:
                    return [ IdeaQuality.NO, IdeaQuality.GOOD, IdeaQuality.MEDIUM, IdeaQuality.BAD]
                case DialogActAgent.ANY_IDEA:
                    return [ IdeaQuality.NO, IdeaQuality.GOOD, IdeaQuality.MEDIUM, IdeaQuality.BAD]
                case DialogActAgent.DRQ_NEW_THEME:
                    return [ IdeaQuality.NO, IdeaQuality.GOOD, IdeaQuality.MEDIUM, IdeaQuality.BAD]
    ...
    def possible_next_da(self):
        match self.bin:
            ...
            case DialogActAgent.PROBLEM_STATEMENT:
                return [  DialogActAgent.DRQ_NEW_THEME, DialogActAgent.ACKNOWLEDGE, DialogActAgent.LLQ]
            case DialogActAgent.ANY_IDEA:
                return [  DialogActAgent.DRQ_NEW_THEME, DialogActAgent.ACKNOWLEDGE, DialogActAgent.LLQ]
            case DialogActAgent.DRQ_NEW_THEME:
                    return [  DialogActAgent.DRQ_NEW_THEME, DialogActAgent.ACKNOWLEDGE, DialogActAgent.LLQ]
